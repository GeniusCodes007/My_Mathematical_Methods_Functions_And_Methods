...
def string_check():
    ...
    while c < words:
        ...
        if character == "." or character == ",":
            character = "_"
        resulting = resulting + character

    if c == words and resulting == "__init__":
        return "__main__.py"
    else:
        return resulting
...
class Trignometry(BasicFrequentFunctions, BasicGraph):
    pass
